...
const $ = new Env("🍿️ DualSubs: 🇳 Netflix v0.9.0(6) Manifest.response.beta");
const URL = new URLs();
const DataBase = {
	"Default":{
...
(async () => {
	...
	switch (Settings.Switch) {
		...
		default:
            ...
            else if (PATH === "msl/playapi/ios/manifest") FORMAT = "application/x-protobuf";
			...
			switch (FORMAT) {
                ...
                case "application/json":
                    ...
                    $.log(`🚧 ${$.name}, JSON.parse($response.body): ${JSON.stringify(body)}`, "");
                ...
                case "application/grpc+proto":
                    ...
                    switch (FORMAT) {
                        case "application/x-protobuf":
                            ...
                            /******************  initialization finish  *******************/
                            body = Manifest.fromBinary(rawBody);
                            $.log(`🚧 ${$.name}, body: ${JSON.stringify(body)}`, "");
                            ...
                            rawBody = Manifest.toBinary(body);
                            break;
                        case "application/grpc":
                        case "application/grpc+proto":
                            break;
