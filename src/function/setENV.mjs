...
export default function setENV(name, platforms, database) {
	...
	log(`✅ Set Environment Variables, Settings: ${typeof Settings}, Settings内容: ${JSON.stringify(Settings, null, 2)}`, "");
	/***************** Caches *****************/
	...
	//log(`✅ Set Environment Variables, Caches: ${typeof Caches}, Caches内容: ${JSON.stringify(Caches, null, 2)}`, "");
	/***************** Configs *****************/
